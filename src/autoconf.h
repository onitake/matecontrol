...
#define CONFIG_MODULE_MD5 1
#define CONFIG_MODULE_MD5_HMAC 1
#undef  CONFIG_MODULE_RC4

/*
 * Encodings modules
 */
#define CONFIG_MODULE_BASE64 1
...
#undef  CONFIG_AVRDUDE_PROG_STK200
...
#define CONFIG_AVRDUDE_PROG_USBTINY 1
#undef  CONFIG_AVRDUDE_PROG_WIRING
#undef  CONFIG_AVRDUDE_PROG_XIL
#undef  CONFIG_AVRDUDE_PROG_XPLAINEDPRO
#define CONFIG_AVRDUDE_PORT "usb"
#define CONFIG_AVRDUDE_BAUDRATE (38400)
...
#undef  CONFIG_AVARICE_PROG_MKI
#undef  CONFIG_AVARICE_PROG_MKII
#define CONFIG_AVARICE_PROG_DRAGON 1
